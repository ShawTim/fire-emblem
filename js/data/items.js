...
const ITEMS = {
  ...
  // Consumables
  vulnerary:    { name: '傷藥', type: 'consumable', uses: 3, heals: 10, price: 300 },

  // Boss weapons
  starCrest:    { name: '翠星之杖', type: 'dark', might: 20, hit: 90, crit: 10, weight: 12, range: [1,2], uses: 99, magic: true, price: 0 },
};
