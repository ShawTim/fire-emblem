...
const CHARACTERS = {
  eirine: { name: '艾琳', classId: 'lord', level: 1, isLord: true, gender: 'f', portrait: { hair: '#c4a', eyes: '#48f', skin: '#fdb' }, baseStats: { hp: 19, str: 4, mag: 1, skl: 7, spd: 9, lck: 9, def: 4, res: 3 }, growths: { hp: 75, str: 50, mag: 15, skl: 50, spd: 60, lck: 60, def: 30, res: 30 }, items: ['rapier'] },
  marcus: { name: '馬庫斯', classId: 'paladin', level: 1, gender: 'm', portrait: { hair: '#666', eyes: '#432', skin: '#eca' }, baseStats: { hp: 28, str: 10, mag: 1, skl: 12, spd: 7, lck: 8, def: 9, res: 6 }, growths: { hp: 40, str: 20, mag: 5, skl: 20, spd: 10, lck: 20, def: 15, res: 10 }, items: ['steelSword', 'ironLance', 'vulnerary'] },
  lina: { name: '莉娜', classId: 'archer', level: 1, gender: 'f', portrait: { hair: '#6c4', eyes: '#4a4', skin: '#fdb' }, baseStats: { hp: 17, str: 5, mag: 0, skl: 7, spd: 7, lck: 4, def: 3, res: 1 }, growths: { hp: 55, str: 40, mag: 5, skl: 55, spd: 55, lck: 35, def: 20, res: 20 }, items: ['ironBow'] },
  thor: { name: '托爾', classId: 'fighter', level: 3, gender: 'm', portrait: { hair: '#d82', eyes: '#654', skin: '#dba' }, baseStats: { hp: 24, str: 8, mag: 0, skl: 4, spd: 4, lck: 3, def: 5, res: 0 }, growths: { hp: 80, str: 55, mag: 5, skl: 30, spd: 25, lck: 25, def: 35, res: 10 }, items: ['ironAxe', 'handAxe'] },
  serra: { name: '賽拉', classId: 'cleric', level: 2, gender: 'f', portrait: { hair: '#ffa', eyes: '#88f', skin: '#fed' }, baseStats: { hp: 16, str: 1, mag: 5, skl: 4, spd: 6, lck: 7, def: 1, res: 7 }, growths: { hp: 45, str: 5, mag: 55, skl: 30, spd: 35, lck: 45, def: 10, res: 55 }, items: ['heal'] },
  cain: { name: '凱恩', classId: 'mercenary', level: 5, gender: 'm', portrait: { hair: '#444', eyes: '#a44', skin: '#dba' }, baseStats: { hp: 22, str: 8, mag: 0, skl: 9, spd: 10, lck: 5, def: 6, res: 1 }, growths: { hp: 65, str: 45, mag: 5, skl: 45, spd: 45, lck: 30, def: 30, res: 15 }, items: ['ironSword', 'vulnerary'] },
  fran: { name: '法蘭', classId: 'mage', level: 5, gender: 'f', portrait: { hair: '#88f', eyes: '#f44', skin: '#fdb' }, baseStats: { hp: 18, str: 1, mag: 9, skl: 6, spd: 8, lck: 4, def: 2, res: 6 }, growths: { hp: 40, str: 5, mag: 65, skl: 40, spd: 45, lck: 25, def: 10, res: 40 }, items: ['fire', 'thunder'] },
  rex: { name: '雷克斯', classId: 'wyvernRider', level: 7, gender: 'm', portrait: { hair: '#854', eyes: '#484', skin: '#dba' }, baseStats: { hp: 26, str: 10, mag: 0, skl: 8, spd: 7, lck: 4, def: 10, res: 1 }, growths: { hp: 60, str: 45, mag: 5, skl: 35, spd: 35, lck: 20, def: 40, res: 10 }, items: ['steelLance', 'javelin'] },
  natasha: { name: 'ナターシャ', classId: 'pegasusKnight', level: 8, gender: 'f', portrait: { hair: '#f8a', eyes: '#4cf', skin: '#fdb' }, baseStats: { hp: 20, str: 7, mag: 3, skl: 9, spd: 13, lck: 8, def: 4, res: 8 }, growths: { hp: 50, str: 35, mag: 20, skl: 45, spd: 60, lck: 40, def: 15, res: 45 }, items: ['ironLance', 'javelin'] },
  olivier: { name: 'オリヴィエ', classId: 'thief', level: 8, gender: 'm', portrait: { hair: '#555', eyes: '#a8a', skin: '#ecb' }, baseStats: { hp: 21, str: 6, mag: 0, skl: 12, spd: 15, lck: 5, def: 4, res: 2 }, growths: { hp: 50, str: 30, mag: 5, skl: 55, spd: 65, lck: 30, def: 20, res: 15 }, items: ['ironSword'] },
  helga: { name: 'ヘルガ', classId: 'general', level: 1, gender: 'f', portrait: { hair: '#964', eyes: '#644', skin: '#d9b' }, baseStats: { hp: 30, str: 14, mag: 0, skl: 7, spd: 3, lck: 2, def: 16, res: 4 }, growths: { hp: 60, str: 40, mag: 0, skl: 20, spd: 15, lck: 15, def: 50, res: 20 }, items: ['steelLance', 'javelin'] },
  morgane: { name: '莫爾甘', gender: 'm', portrait: { hair: '#206', eyes: '#f0f', skin: '#baa' } },
  king: { name: '國王', gender: 'm', portrait: { hair: '#fff', eyes: '#432', skin: '#fec' } },
  guardCaptain: { name: '守衛隊長', classId: 'knight', level: 3, gender: 'm', portrait: { hair: '#4a4a4a', eyes: '#b22', skin: '#d6b08a' } }
};
...
const TERRAIN_CODES = {
  ...
  H: 'hill', S: 'swamp', C: 'cliff',
  N: 'pass', D: 'road', A: 'basin',
  E: 'sea', K: 'desert', X: 'bridge',
  U: 'ruins', Z: 'stairs', B: 'brazier',
  '.': 'plain', ' ': 'plain'
};
