...
const CHARACTERS = {
  ...
  king: { name: '國王', classId: 'lord', level: 1, portrait: { hair: '#fff', eyes: '#432', skin: '#fec' }, baseStats: { hp: 30, str: 10, mag: 5, skl: 12, spd: 8, lck: 15, def: 10, res: 12 }, growths: { hp: 40, str: 30, mag: 20, skl: 40, spd: 20, lck: 50, def: 30, res: 40 }, items: [] }
};
