...
const CHARACTERS = {
  eirine: { name: '艾琳', classId: 'lord', level: 1, isLord: true, gender: 'f', portrait: { hair: '#c4a', eyes: '#48f', skin: '#fdb' }, baseStats: { hp: 22, str: 4, mag: 1, skl: 7, spd: 9, lck: 9, def: 5, res: 4 }, growths: { hp: 75, str: 50, mag: 15, skl: 50, spd: 60, lck: 60, def: 30, res: 30 }, items: ['rapier'] },
