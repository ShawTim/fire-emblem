...
const CLASSES = {
  ...
  archer: {
    ...
    sprites: { stand: 'archer_stand.png', move: 'archer_move.png', frames: 3 },
    caps: { hp:60, str:20, mag:5, skl:20, spd:20, lck:30, def:20, res:20 }
  },
  sniper: {
    name: '狙擊手', weapons: ['bow'], mov: 6, promoted: true,
    sprites: { stand: 'sniper_stand.png', move: 'sniper_move.png', frames: 3 },
  ...
  fighter: {
    ...
    sprites: { stand: 'fighter_stand.png', move: 'fighter_move.png' }
  },
  warrior: {
  ...
  mercenary: {
    ...
    sprites: { stand: 'mercenary_stand.png', move: 'mercenary_move.png', frames: 3 },
    caps: { hp:60, str:20, mag:5, skl:20, spd:20, lck:30, def:20, res:20 }
  },
  swordmaster: {
    name: '劍聖', weapons: ['sword'], mov: 6, promoted: true,
    sprites: { stand: 'swordmaster_stand.png', move: 'swordmaster_move.png', frames: 3 },
  ...
  cleric: {
    ...
    sprites: { stand: 'cleric_stand.png', move: 'cleric_move.png', frames: 3 },
    caps: { hp:60, str:5, mag:20, skl:20, spd:20, lck:30, def:10, res:25 }
  },
  bishop: {
    name: '司祭', weapons: ['staff','fire','thunder','wind'], mov: 5, promoted: true,
    sprites: { stand: 'bishop_stand.png', move: 'bishop_move.png', frames: 3 },
  ...
  thief: {
    ...
    promo: [{ to: 'assassin' }],
    sprites: { stand: 'thief_stand.png', move: 'thief_move.png', frames: 3 },
    caps: { hp:60, str:18, mag:5, skl:24, spd:26, lck:30, def:14, res:16 }
  },
  assassin: {
    name: '刺客', weapons: ['sword'], mov: 6, promoted: true,
    sprites: { stand: 'assassin_stand.png', move: 'assassin_move.png', frames: 3 },
  ...
  general: {
    ...
    sprites: { stand: 'general_stand.png', move: 'general_move.png', frames: 3 },
