...
const CLASSES = {
  lord: {
    ...
    baseStats: { hp:20, str:6, mag:5, skl:6, spd:6, lck:10, def:6, res:6 }
  },
  masterLord: {
    name: '聖王', weapons: ['sword','lance'], mov: 6, promoted: true,
    caps: { hp:60, str:25, mag:20, skl:25, spd:25, lck:30, def:25, res:25 },
    baseStats: { hp:20, str:8, mag:6, skl:8, spd:8, lck:10, def:8, res:8 },
  ...
  cavalier: {
    ...
    baseStats: { hp:20, str:6, mag:1, skl:6, spd:6, lck:10, def:6, res:6 }
  },
  paladin: {
    ...
    baseStats: { hp:20, str:8, mag:3, skl:8, spd:8, lck:10, def:8, res:8 },
  ...
  greatKnight: {
    ...
    baseStats: { hp:20, str:9, mag:1, skl:6, spd:6, lck:10, def:9, res:5 },
  ...
  sniper: {
    ...
    baseStats: { hp:20, str:8, mag:1, skl:10, spd:8, lck:10, def:6, res:6 },
  ...
  ranger: {
    ...
    baseStats: { hp:20, str:7, mag:1, skl:8, spd:8, lck:10, def:7, res:7 },
    bonus: { hp:3, str:2, skl:2, spd:2, def:2, res:2 }
  },
  fighter: {
    ...
    baseStats: { hp:20, str:7, mag:1, skl:6, spd:6, lck:10, def:6, res:5 }
  },
  warrior: {
    name: '勇者', weapons: ['axe','bow'], mov: 6, promoted: true,
    caps: { hp:60, str:30, mag:5, skl:24, spd:22, lck:30, def:22, res:15 },
    baseStats: { hp:20, str:10, mag:1, skl:8, spd:7, lck:10, def:7, res:5 },
  ...
  hero: {
    ...
    baseStats: { hp:20, str:8, mag:1, skl:9, spd:8, lck:10, def:7, res:6 },
    bonus: { hp:3, str:2, skl:2, spd:2, def:2, res:2 }
  },
  mercenary: {
  ...
  swordmaster: {
    ...
    baseStats: { hp:20, str:7, mag:1, skl:10, spd:10, lck:10, def:6, res:7 },
  ...
  cleric: {
    ...
    baseStats: { hp:20, str:1, mag:6, skl:6, spd:6, lck:10, def:3, res:8 }
  },
  bishop: {
    name: '司祭', weapons: ['staff','fire','thunder','wind'], mov: 5, promoted: true,
    caps: { hp:60, str:5, mag:28, skl:25, spd:22, lck:30, def:15, res:30 },
    baseStats: { hp:20, str:1, mag:9, skl:8, spd:7, lck:10, def:5, res:10 },
  ...
  valkyrie: {
    ...
    baseStats: { hp:20, str:1, mag:8, skl:7, spd:8, lck:10, def:4, res:9 },
  ...
  mageKnight: {
    ...
    baseStats: { hp:20, str:1, mag:8, skl:7, spd:8, lck:10, def:6, res:7 },
  ...
  wyvernRider: {
    ...
    baseStats: { hp:20, str:7, mag:1, skl:6, spd:6, lck:10, def:7, res:3 }
  },
  wyvernLord: {
    ...
    baseStats: { hp:20, str:9, mag:1, skl:8, spd:7, lck:10, def:9, res:5 },
  ...
  pegasusKnight: {
    ...
    baseStats: { hp:20, str:6, mag:3, skl:7, spd:8, lck:10, def:5, res:7 }
  },
  falconKnight: {
    ...
    baseStats: { hp:20, str:7, mag:5, skl:8, spd:9, lck:10, def:6, res:9 },
  ...
  thief: {
    ...
    baseStats: { hp:20, str:6, mag:1, skl:8, spd:8, lck:10, def:4, res:5 }
  },
  assassin: {
    name: '刺客', weapons: ['sword'], mov: 6, promoted: true,
    caps: { hp:60, str:22, mag:5, skl:30, spd:30, lck:30, def:18, res:20 },
    baseStats: { hp:20, str:7, mag:1, skl:10, spd:10, lck:10, def:6, res:6 },
    bonus: { hp:2, str:2, skl:3, spd:3, def:1, res:2 },
    critBonus: 15
  },
  general: {
    ...
    baseStats: { hp:20, str:9, mag:1, skl:7, spd:4, lck:10, def:10, res:4 },
